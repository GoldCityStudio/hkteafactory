...
const HoneyProductPage = () => {
  ...
  const honeyHeroSection = {
    headline: '蜂蜜精選',
    subheadline: '探索天然純淨的蜂蜜系列',
    button: '立即探索',
    leafColor: '#FFD700', // A golden yellow color for honey
    bg: 'from-yellow-600 via-yellow-700 to-yellow-500',
    bgImage: '/images/hero-honey.jpg'
  };
      ...
      <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
            ...
            >
              我們的蜂蜜系列產品選用優質蜜源，經過嚴格的品質控制，為您帶來最純正、最營養的蜂蜜產品。每一滴蜂蜜都蘊含著大自然的精華，是您健康生活的理想選擇。
            </motion.p>
            ...
            >
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <span className="font-semibold text-gray-900">純天然：</span>
                    100%純正蜂蜜，無添加任何人工成分
                  </li>
                  <li>
                    <span className="font-semibold text-gray-900">優質蜜源：</span>
                    精選優質蜜源，確保蜂蜜品質
                  </li>
                  <li>
                    <span className="font-semibold text-gray-900">營養豐富：</span>
                    富含多種維生素和礦物質
                  </li>
                  <li>
