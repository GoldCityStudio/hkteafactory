...
const TaiwanTeaPage = () => {
  ...
  const taiwanTeaHeroSection = {
    headline: '台灣茶精選',
    subheadline: '探索高山韻味的台灣茶系列',
    button: '立即探索',
    leafColor: '#8FBC8F', // A medium green color for Taiwan tea
    bg: 'from-green-800 via-green-900 to-green-700',
    bgImage: '/images/hero-taiwan-tea.jpg'
  };
      ...
      <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
            ...
            >
              台灣茶以其獨特的高山環境和精湛的製茶工藝而聞名。我們的台灣茶系列精選來自各大名茶產區的優質茶葉，為您帶來最純正的台灣茶體驗。
            </motion.p>
