...
const content: Record<Language, { heroSection: HeroSectionType; products: Product[] }> = {
  zh: {
    ...
    products: [
      {
        id: 'longjing-green',
        name: { zh: '西湖龍井', en: 'West Lake Longjing' },
        description: { zh: '中國十大名茶之首', en: 'Top 10 Chinese Tea' },
        price: 180,
      ...
      {
        id: 'biluochun',
        name: { zh: '碧螺春', en: 'Bi Luo Chun' },
        description: { zh: '洞庭碧螺春，清香回甘', en: 'Dongting Bi Luo Chun, refreshing and sweet aftertaste' },
        price: 150,
        originalPrice: undefined,
      ...
      {
        id: 'maofeng',
        name: { zh: '黃山毛峰', en: 'Huangshan Maofeng' },
        description: { zh: '安徽黃山毛峰，高山雲霧茶', en: 'Anhui Huangshan Maofeng, high mountain cloud tea' },
        price: 130,
        originalPrice: undefined,
        thumbnail: '/images/maofeng.jpg',
        images: ['/images/maofeng.jpg'],
        category: 'green-tea',
        status: 'active',
        isNew: false,
        specifications: {
