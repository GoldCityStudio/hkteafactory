...
export default function PartyFavorsPage() {
  return (
      ...
      <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
            ...
            >
              「烘茶源」的宴會回禮定制服務，為您的婚宴、壽宴、商務宴會等場合提供獨具特色的回禮選擇。我們精心設計的回禮禮品，不僅能讓賓客感受到您的用心，更能為您的宴會增添一份獨特的魅力。
            </motion.p>
