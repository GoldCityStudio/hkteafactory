  ...
  zh: {
    products: [
      ...
      },
      {
        ...
        images: ['/images/longjing-yuqian.jpg', '/images/longjing-first.jpg'],
        category: 'green-tea' as const,
        status: 'active' as const,
        isNew: false,
        specifications: {
      ...
      },
      {
        ...
        images: ['/images/taiwan-ginseng-oolong.jpg', '/images/tieguanyin-premium.jpg'],
      ...
      },
      {
        ...
        images: ['/images/monkey-pick-tieguanyin.jpg', '/images/tieguanyin-gift.jpg'],
        category: 'oolong-tea' as const,
        status: 'active' as const,
        isNew: false,
        specifications: {
      ...
      },
      {
        ...
        images: ['/images/snow-bud-silver-needle.jpg', '/images/white-tea.jpg'],
      ...
      },
      {
        ...
        images: ['/images/linden-honey.jpg', '/images/honey-premium.jpg'],
...
function VideoCarousel() {
  ...
  const youtubeEmbedUrl = 'https://www.youtube.com/embed/q_rAB87mXPY?autoplay=1&mute=1&loop=1&playlist=q_rAB87mXPY&controls=0&showinfo=0&rel=0&modestbranding=1';
